...
```bash
python practice4/광주_3반_practice4.py
python practice5/광주_3반_practice5.py
```
...
실행별 HTML, 최신 HTML, KPI 실행 이력이 `Total3/output`에 생성됩니다.

## Advanced: 고객 이탈 대응 우선순위

```bash
python Advanced/churn_action_report.py
```

Total2 모델의 임계값을 비교하고 고객별 이탈 위험도와 연락 우선순위를 생성합니다.
